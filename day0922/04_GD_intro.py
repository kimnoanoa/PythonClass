...
# 신경망의 활성화 함수로도 이용됨
# 장점 : 확률해석 가능
# 단점 :  큰 입력값을 넣으면 그래디언트 소실(기울기 값이 점점 작아져 0에 가까워지는 현상) 이 발생함 -> 깊은 신경망을 학습하기 어렵고, 매우 느려지거나 멈추게 됨

# -특성공학
# 원본 데이터만으로는 성능이 부족할 때 주로 사용하거나, 머신러닝 모델 성능을 높이기 위해 원본 데이터에서 새로운 특성을 생성하고 변환하는 과정임. 
